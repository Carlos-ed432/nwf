Meus estudos de python
 ...
 #### Programas que criei para aprender a lógica:
 ## Algoritmo para receber sete valores(anos) em int para filtrar e mostrar na tela quantas pessoas são maiores de idade.
...
## Adivinhação - adivinhar o número de 1 a 10 que a máquina está "pensando" e responder até acertar. Contando as tentativas até o acerto.
